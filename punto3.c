...
int main()
{
    ...
    do
    {
        ...
        case 1:
            while (Op2 == 1)
            {
                tareaAux = cargarTarea(&id);
                AgregarLibro(&listaP, tareaAux);
        ...
        case 3:
            ...
            printf("   ----------Muestro lista de realizados----------  \n ");
            MostrarLista(listaR);
            break;

        case 4:
            printf("   ----------Muestro lista de pendientes----------  \n ");
            MostrarLista(listaP);
            break;
        case 5:
            eliminarTareaPorId(&listaP, &listaR);
...
void moverTarea(Nodo **listaPend, Nodo **listaR)
{
    ...
    while (aux)
    {
        ...
        puts(aux->tarea.descripcion);
        printf("la duracion de la tarea es : %d \n ", aux->tarea.duracion);
        printf("realizo este tarea?  Ingrese 1 para si 0 para no\n");
        scanf("%d", &opcion);
        fflush(stdin);
        if (opcion == 1)
        {
